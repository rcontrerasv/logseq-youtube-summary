...
const translations: Record<Language, Translations> = {
  en: {
    settings: {
      ...
      apiKey: 'API Key',
      apiKeyDescription: 'Enter your API key for the selected model. Check their developer portal to generate one.',
      model: 'Model',
...
Conclusion: [Main takeaway or message from the video]`,
  ...
  es: {
    settings: {
      ...
      apiKey: 'API Key',
      apiKeyDescription: 'Ingresa tu API key para el modelo seleccionado. Consúltala en el portal de desarrolladores del proveedor.',
      model: 'Modelo',
